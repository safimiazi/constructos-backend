...
export class HrController {
  ...
  @Delete('employees/:id') @HttpCode(HttpStatus.NO_CONTENT) removeEmployee(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ) {
  ...
  // Departments
  @Get('departments') findDepts(@CurrentUser() u: JwtPayload) {
    return this.svc.findDepartments(u.tenantId!);
  }
  @Post('departments') createDept(
    @CurrentUser() u: JwtPayload,
    @Body() dto: any,
  ) {
    return this.svc.createDepartment(u.tenantId!, u.sub, dto);
  }
  @Patch('departments/:id') updateDept(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
    @Body() dto: any,
  ) {
  ...
  @Delete('departments/:id') @HttpCode(HttpStatus.NO_CONTENT) removeDept(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ) {
  ...
  // Attendance
  @Get('attendance') findAttendance(
    @CurrentUser() u: JwtPayload,
    @Query() q: any,
  ) {
    return this.svc.findAttendance(u.tenantId!, q);
  }
  @Get('attendance/summary') getAttSummary(
    @CurrentUser() u: JwtPayload,
  ...
  @Post('attendance/clock-in') clockIn(
    @CurrentUser() u: JwtPayload,
    @Body() dto: { employeeId: string; location?: string },
  ) {
  ...
  // Leave Types
  @Get('leave-types') findLeaveTypes(@CurrentUser() u: JwtPayload) {
  ...
  // Leave
  @Get('leaves') findLeaves(@CurrentUser() u: JwtPayload, @Query() q: any) {
    return this.svc.findLeaves(u.tenantId!, q);
  }
  @Post('leaves') createLeave(@CurrentUser() u: JwtPayload, @Body() dto: any) {
    return this.svc.createLeave(u.tenantId!, u.sub, dto);
  }
  @Patch('leaves/:id/approve') approveLeave(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ) {
    return this.svc.approveLeave(u.tenantId!, id, u.sub);
  }
  @Patch('leaves/:id/reject') rejectLeave(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ...
  // Payroll
  @Get('payroll/runs') findPayrollRuns(@CurrentUser() u: JwtPayload) {
    return this.svc.findPayrollRuns(u.tenantId!);
  }
  @Post('payroll/runs') createPayrollRun(
    @CurrentUser() u: JwtPayload,
    @Body() dto: { payPeriod: string },
  ) {
    return this.svc.createPayrollRun(u.tenantId!, u.sub, dto.payPeriod);
  }
  @Get('payroll/runs/:id/items') getPayrollItems(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ) {
    return this.svc.getPayrollItems(u.tenantId!, id);
  }
  @Patch('payroll/items/:id') updatePayrollItem(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
    @Body() dto: any,
  ) {
  ...
  @Patch('payroll/runs/:id/approve') approvePayrollRun(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ) {
  ...
  // Recruitment
  @Get('jobs') findJobs(@CurrentUser() u: JwtPayload) {
    return this.svc.findJobs(u.tenantId!);
  }
  @Post('jobs') createJob(@CurrentUser() u: JwtPayload, @Body() dto: any) {
  ...
  @Get('jobs/:id/applicants') findApplicants(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ) {
    return this.svc.findApplicants(u.tenantId!, id);
  }
  @Post('jobs/:id/applicants') createApplicant(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
    @Body() dto: any,
  ) {
  ...
  @Patch('applicants/:id/stage') moveStage(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
    @Body() dto: { stage: ApplicantStage },
  ) {
    return this.svc.moveApplicantStage(u.tenantId!, id, dto.stage);
  }

  // Payslips
  @Post('payroll/runs/:id/payslips') generatePayslips(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ) {
    return this.svc.generatePayslips(u.tenantId!, id);
  }
  @Get('payroll/employees/:id/payslips') getPayslips(
    @CurrentUser() u: JwtPayload,
    @Param('id') id: string,
  ) {
  ...
  // HR Analytics
  @Get('analytics') getAnalytics(@CurrentUser() u: JwtPayload) {
