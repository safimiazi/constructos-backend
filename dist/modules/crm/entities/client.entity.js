...
exports.Client = exports.ClientType = void 0;
...
let Client = class Client extends base_entity_1.TenantBaseEntity {
    name;
    type;
    contactPerson;
    email;
...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ClientType, default: ClientType.COMPANY }),
    __metadata("design:type", String)
